...
# print("training on blogs and testing on movies")
# train_x, train_y = blog_processing.get_blog_data()
# test_x, test_y = data_processing.get_movie_data()
# lines = train_x + test_x

# print("training on blogs and testing on switchboard")
# train_x, train_y = blog_processing.get_blog_data()
# test_x, test_y = switchboard_processing.get_switchboard_data()
# lines = train_x + test_x

# print("training on blogs and testing on twitter")
# train_x, train_y = blog_processing.get_blog_data()
# test_x, test_y = twitter_processing.get_tweets_data()
# lines = train_x + test_x
...
print("Naive Bayes")
accuracy = train_model(naive_bayes.MultinomialNB(), train_x_count, train_y, test_x_count, print_bool = False, featurizer = count_vec)
print("Count: ")
print(accuracy)

#print("Printing features of naive bayes to text file...")

accuracy = train_model(naive_bayes.MultinomialNB(), train_x_count_2, train_y, test_x_count_2, print_bool = False, featurizer = count_vec_2)
print("Count (bigrams): ")
print(accuracy)
accuracy = train_model(naive_bayes.MultinomialNB(), train_x_counts, train_y, test_x_counts, print_bool = False, featurizer = only_counts)
print("All Counts: ")
print(accuracy)
accuracy = train_model(naive_bayes.MultinomialNB(), train_x_tfidif_word, train_y, test_x_tfidif_word, print_bool = False, featurizer = tfidf_vec_word)
print("Word TF-IDF: ")
print(accuracy)
accuracy = train_model(naive_bayes.MultinomialNB(), train_x_tfidif_ngram, train_y, test_x_tfidif_ngram, print_bool = False, featurizer = tfidf_vec_ngram)
print("N-Gram TF-IDF: ")
print(accuracy)
accuracy = train_model(naive_bayes.MultinomialNB(), train_x_combined, train_y, test_x_combined, print_bool = False, featurizer = all_features)
print("All: ")
print(accuracy)
